package com.rainbow.smartring.core.log;
...
public class Logger extends FrameLayout implements Thread.UncaughtExceptionHandler, Application.ActivityLifecycleCallbacks {
    private static boolean debuggable; //正式环境(false)不打印日志，也不能唤起app的debug界面
    ...
    private Logger(final Context context) {
        ...
        LayoutParams layoutParams = new LayoutParams(widthPixels / 2, heightPixels / 2, Gravity.CENTER);
    ...
    public static void debug(boolean debuggable) {
        Logger.debuggable = debuggable;
    }
...
//        if (dis > 2000) clearClick();
    ...
    private View initDialogView() {
        ...
        spinner.setAdapter(new ArrayAdapter<>(mCurrentActivity,
    ...
    private class LeakCheck {
        ...
        WeakReference<Object> mPhantomReference = new WeakReference<>(new Object(), mQueue);
