...
public class HrData {
    ...
    @Generated(hash = 1770792659)
    private transient HrDataDao myDao;

    @Generated(hash = 1891296345)
    public HrData(Long id, Long uid, @NotNull Integer hr, @NotNull Date date) {
        this.id = id;
        this.uid = uid;
        this.hr = hr;
        this.date = date;
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1675292969)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getHrDataDao() : null;
    }
}
